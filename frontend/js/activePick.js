...
window.addEventListener('storage', (e) => {
  ...
  if (isPhase) {
    ...
    const current = fiveVisualPhases[phaseNumber - 1];
    if (current) {
      if (phase !== 0) {
